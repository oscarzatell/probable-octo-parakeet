...
function _default(program) {
  program.command('apply [project-dir]').option('--platform [platform]', 'Configure only the given platform ("ios" or "android")') // .option('--interactive', 'TODO: provide a flag where people can see a diff for each option to be applied and approve or reject it')
