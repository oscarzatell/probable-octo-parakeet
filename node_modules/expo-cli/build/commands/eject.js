...
async function action(projectDir, options) {
  let {
    exp
  } = (0, _config().getConfig)(projectDir); // Set EXPO_VIEW_DIR to universe/exponent to pull expo view code locally instead of from S3 for ExpoKit

  if (_xdl().Versions.lteSdkVersion(exp, '36.0.0')) {
    // Don't show a warning if we haven't released SDK 37 yet
    let latestReleasedVersion = await _xdl().Versions.newestReleasedSdkVersionAsync();
