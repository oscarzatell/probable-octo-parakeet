...
function _find() {
  const data = _interopRequireDefault(require("lodash/find"));
...
function _assign() {
  const data = _interopRequireDefault(require("lodash/assign"));
...
class IosApi {
  ...
  async getPushCert(experienceName, bundleIdentifier) {
    ...
    const pushId = (0, _get().default)(appCredentials, 'credentials.pushId');
    const pushP12 = (0, _get().default)(appCredentials, 'credentials.pushP12');
    const pushPassword = (0, _get().default)(appCredentials, 'credentials.pushPassword');
  ...
  async updateProvisioningProfile(experienceName, bundleIdentifier, provisioningProfile, appleTeam) {
    ...
    const credIndex = (0, _findIndex().default)(this.credentials.appCredentials, app => app.experienceName === experienceName && app.bundleIdentifier === bundleIdentifier);
    (0, _assign().default)(this.credentials.appCredentials[credIndex].credentials, provisioningProfile);
  ...
  async getAppCredentials(experienceName, bundleIdentifier) {
    ...
    return (0, _find().default)(this.credentials.appCredentials, app => app.experienceName === experienceName && app.bundleIdentifier === bundleIdentifier);
  }

  async getProvisioningProfile(experienceName, bundleIdentifier) {
    const appCredentials = await this.getAppCredentials(experienceName, bundleIdentifier);
    const provisioningProfile = (0, _get().default)(appCredentials, 'credentials.provisioningProfile');
