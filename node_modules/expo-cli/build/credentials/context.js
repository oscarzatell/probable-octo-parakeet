...
class Context {
  ...
  async init(projectDir, options = {}) {
    ...
    if (status !== _xdl().Doctor.FATAL) {
      ...
      this._iosApiClient = new (_api().IosApi)(this.user).withProjectContext(this);
      (0, _log().default)(`Configuring credentials for ${(_this$manifest$owner = this.manifest.owner) !== null && _this$manifest$owner !== void 0 ? _this$manifest$owner : this.user.username} in project ${this.manifest.slug}`);
    } else {
