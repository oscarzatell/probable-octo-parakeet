...
const resolvers = {
    ...
    Mutation: {
        ...
        async setProjectSettings(parent, { settings }, context) {
            const currentProject = context.getCurrentProject();
            let updatedSettings = await xdl_1.ProjectSettings.setAsync(currentProject.projectDir, settings);
        ...
        async sendProjectUrl(parent, { recipient }, context) {
            const currentProject = context.getCurrentProject();
            let url = await xdl_1.UrlUtils.constructManifestUrlAsync(currentProject.projectDir);
            let result = await xdl_1.Exp.sendAsync(recipient, url);
