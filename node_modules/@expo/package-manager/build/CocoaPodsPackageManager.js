...
class CocoaPodsPackageManager {
    ...
    static isUsingPods(projectRoot) {
        return fs_extra_1.default.existsSync(path_1.default.join(projectRoot, 'Podfile'));
    }
    ...
    async _installAsync(shouldUpdate = true) {
        ...
        try {
            ...
            const stderr = (_a = error.stderr, (_a !== null && _a !== void 0 ? _a : error.stdout));
    ...
    async podRepoUpdateAsync() {
        ...
        try {
            ...
            throw new Error((_a = error.stderr, (_a !== null && _a !== void 0 ? _a : error.stdout)));
        }
    }
